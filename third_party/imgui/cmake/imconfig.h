...
// Disable default embedded fonts (ProggyClean/ProggyForever), remove ~9 KB + ~14 KB from output binary.
// AddFontDefaultXXX() functions will assert. #define IMGUI_DISABLE_SSE                                 // Disable use
// of SSE intrinsics even if available
...
// is simply a convenience. On Windows you may use vcpkg with 'vcpkg install freetype --triplet=x64-windows' + 'vcpkg
// integrate install'.
...
#define ImTextureID VkImageView
